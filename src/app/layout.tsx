...
export const metadata = {
  ...
  icons: {
    icon: [
      { url: '/farm-basket-logo.svg', type: 'image/svg+xml' },
      { url: '/favicon.ico' }
    ],
    apple: '/farm-basket-logo.svg',
  }
};
        ...
        <footer className="bg-amber-900 text-white py-8 mt-12">
          <div className="container mx-auto px-4 md:px-8">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div>
                <h3 className="text-xl font-semibold mb-4 text-amber-100 drop-shadow-sm">Find my Farmers Market</h3>
                <p className="text-amber-100">Connecting communities with fresh, local produce since 2023</p>
              </div>
              <div>
                <h3 className="text-xl font-semibold mb-4 text-amber-100 drop-shadow-sm">Resources</h3>
              ...
              <div>
                <h3 className="text-xl font-semibold mb-4 text-amber-100 drop-shadow-sm">Data Sources</h3>
